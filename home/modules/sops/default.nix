...
# `nix run nixpkgs#sops -- home/modules/sops/secrets.yaml` (from the root of the repo)
...
# `SOPS_AGE_KEY_FILE=~/.config/sops/age/keys.txt sops updatekeys home/modules/sops/secrets.yaml`
